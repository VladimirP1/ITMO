...
happyExpList = Happy_Data_Array.listArray (0,34) ([1408,704,1024,64,0,0,22,11,0,24600,45057,32768,0,5632,0,0,0,128,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","E","D","C","T","var","'!'","'&'","'('","')'","'|'","'->'","%eof"]
        bit_start = st * 15
        bit_end = (st + 1) * 15
...
happyReduction_2 (HappyAbsSyn4  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (nodeImplies happy_var_1 happy_var_3
	)
...
happyReduction_4 (HappyAbsSyn6  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn5
		 (nodeOr      happy_var_1 happy_var_3
	)
...
happyReduction_6 (HappyAbsSyn7  happy_var_3)
	...
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn6
		 (nodeAnd     happy_var_1 happy_var_3
	)
